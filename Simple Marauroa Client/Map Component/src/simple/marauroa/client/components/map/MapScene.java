...
public class MapScene extends GraphScene<String, String> {
    ...
    public MapScene() {
        ...
        //If this is not done, an IllegalStateException will be raised when repositioning the conection widget
    ...
    public void initMap() {
        ...
        myMap.getMainMap().setOverlayPainter(new Painter() {
            @Override
