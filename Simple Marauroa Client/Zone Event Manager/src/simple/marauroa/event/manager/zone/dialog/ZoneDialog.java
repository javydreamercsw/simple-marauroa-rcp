    ...
    public void update(int mode) {
        ...
        switch (mode) {
            ...
            case ZoneEvent.UPDATE:
                ...
                Zone zone = (Zone) Utilities.actionsGlobalContext().lookup(IRPZone.class);
                roomName.setText(Tool.getZoneName(zone.getID()));
                description.setText(zone.getDescription() == null ? "" : zone.getDescription().trim());
        ...
        if (roomName.getText().trim().isEmpty() || roomName.getText().trim().contains(":") || roomName.getText().trim().contains("#")) {
            ...
            if (MCITool.getClient() != null) {
                ...
                switch (mode) {
                    ...
                    case ZoneEvent.UPDATE:
                        if (description.getText().trim().isEmpty()
                                && roomPassword.getPassword().length > 0
                                && !roomPassword.getPassword().toString().trim().isEmpty()) {
                            clean();
                            //Nothing changed
                            return;
