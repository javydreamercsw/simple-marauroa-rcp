...
public final class MapScene extends GraphScene<String, String>
{
   ...
   */
  private final ComponentWidget mapWidget;
  private final LayerWidget mapLayer;
  ...
  public MapScene()
  {
    ...
    /**
     *
     * The map. We use JXMapKit instead of JXMapViewer because the kit includes
     * the zoom slider, a satellite view and and a JXMapViewer
     */
    myMap = new JXMapKit();
  ...
  /**
   * Used to update the map widget bounds to match the container size since this
   * is not possible to do it using a layout
   */
