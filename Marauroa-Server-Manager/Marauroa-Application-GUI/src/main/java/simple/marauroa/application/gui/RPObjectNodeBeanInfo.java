 ...
 */
public class RPObjectNodeBeanInfo extends SimpleBeanInfo {

    // Bean descriptor//GEN-FIRST:BeanDescriptor
    /*lazy BeanDescriptor*/
    private static BeanDescriptor getBdescriptor(){
        BeanDescriptor beanDescriptor = new BeanDescriptor  ( simple.marauroa.application.gui.RPObjectNode.class , null ); // NOI18N//GEN-HEADEREND:BeanDescriptor
    ...
    private static PropertyDescriptor[] getPdescriptor(){
        ...
        try {
            properties[PROPERTY_actions] = new PropertyDescriptor ( "actions", simple.marauroa.application.gui.RPObjectNode.class, "getActions", null ); // NOI18N
            properties[PROPERTY_children] = new PropertyDescriptor ( "children", simple.marauroa.application.gui.RPObjectNode.class, "getChildren", null ); // NOI18N
            properties[PROPERTY_contextActions] = new PropertyDescriptor ( "contextActions", simple.marauroa.application.gui.RPObjectNode.class, "getContextActions", null ); // NOI18N
            properties[PROPERTY_contextMenu] = new PropertyDescriptor ( "contextMenu", simple.marauroa.application.gui.RPObjectNode.class, "getContextMenu", null ); // NOI18N
            properties[PROPERTY_customizer] = new PropertyDescriptor ( "customizer", simple.marauroa.application.gui.RPObjectNode.class, "getCustomizer", null ); // NOI18N
            properties[PROPERTY_defaultAction] = new PropertyDescriptor ( "defaultAction", simple.marauroa.application.gui.RPObjectNode.class, "getDefaultAction", "setDefaultAction" ); // NOI18N
            properties[PROPERTY_displayName] = new PropertyDescriptor ( "displayName", simple.marauroa.application.gui.RPObjectNode.class, "getDisplayName", "setDisplayName" ); // NOI18N
            properties[PROPERTY_expert] = new PropertyDescriptor ( "expert", simple.marauroa.application.gui.RPObjectNode.class, "isExpert", "setExpert" ); // NOI18N
            properties[PROPERTY_handle] = new PropertyDescriptor ( "handle", simple.marauroa.application.gui.RPObjectNode.class, "getHandle", null ); // NOI18N
            properties[PROPERTY_helpCtx] = new PropertyDescriptor ( "helpCtx", simple.marauroa.application.gui.RPObjectNode.class, "getHelpCtx", null ); // NOI18N
            properties[PROPERTY_hidden] = new PropertyDescriptor ( "hidden", simple.marauroa.application.gui.RPObjectNode.class, "isHidden", "setHidden" ); // NOI18N
            properties[PROPERTY_htmlDisplayName] = new PropertyDescriptor ( "htmlDisplayName", simple.marauroa.application.gui.RPObjectNode.class, "getHtmlDisplayName", null ); // NOI18N
            properties[PROPERTY_icon] = new IndexedPropertyDescriptor ( "icon", simple.marauroa.application.gui.RPObjectNode.class, null, null, "getIcon", null ); // NOI18N
            properties[PROPERTY_iconBase] = new PropertyDescriptor ( "iconBase", simple.marauroa.application.gui.RPObjectNode.class, null, "setIconBase" ); // NOI18N
            properties[PROPERTY_iconBaseWithExtension] = new PropertyDescriptor ( "iconBaseWithExtension", simple.marauroa.application.gui.RPObjectNode.class, null, "setIconBaseWithExtension" ); // NOI18N
            properties[PROPERTY_leaf] = new PropertyDescriptor ( "leaf", simple.marauroa.application.gui.RPObjectNode.class, "isLeaf", null ); // NOI18N
            properties[PROPERTY_lookup] = new PropertyDescriptor ( "lookup", simple.marauroa.application.gui.RPObjectNode.class, "getLookup", null ); // NOI18N
            properties[PROPERTY_name] = new PropertyDescriptor ( "name", simple.marauroa.application.gui.RPObjectNode.class, "getName", "setName" ); // NOI18N
            properties[PROPERTY_newTypes] = new PropertyDescriptor ( "newTypes", simple.marauroa.application.gui.RPObjectNode.class, "getNewTypes", null ); // NOI18N
            properties[PROPERTY_openedIcon] = new IndexedPropertyDescriptor ( "openedIcon", simple.marauroa.application.gui.RPObjectNode.class, null, null, "getOpenedIcon", null ); // NOI18N
            properties[PROPERTY_parentNode] = new PropertyDescriptor ( "parentNode", simple.marauroa.application.gui.RPObjectNode.class, "getParentNode", null ); // NOI18N
            properties[PROPERTY_preferred] = new PropertyDescriptor ( "preferred", simple.marauroa.application.gui.RPObjectNode.class, "isPreferred", "setPreferred" ); // NOI18N
            properties[PROPERTY_preferredAction] = new PropertyDescriptor ( "preferredAction", simple.marauroa.application.gui.RPObjectNode.class, "getPreferredAction", null ); // NOI18N
            properties[PROPERTY_propertySets] = new PropertyDescriptor ( "propertySets", simple.marauroa.application.gui.RPObjectNode.class, "getPropertySets", null ); // NOI18N
            properties[PROPERTY_shortDescription] = new PropertyDescriptor ( "shortDescription", simple.marauroa.application.gui.RPObjectNode.class, "getShortDescription", "setShortDescription" ); // NOI18N
        }
    ...
    private static EventSetDescriptor[] getEdescriptor(){
        ...
        try {
            eventSets[EVENT_nodeListener] = new EventSetDescriptor ( simple.marauroa.application.gui.RPObjectNode.class, "nodeListener", org.openide.nodes.NodeListener.class, new String[] {"childrenAdded", "childrenRemoved", "childrenReordered", "nodeDestroyed"}, "addNodeListener", "removeNodeListener" ); // NOI18N
            eventSets[EVENT_propertyChangeListener] = new EventSetDescriptor ( simple.marauroa.application.gui.RPObjectNode.class, "propertyChangeListener", java.beans.PropertyChangeListener.class, new String[] {"propertyChange"}, "addPropertyChangeListener", "removePropertyChangeListener" ); // NOI18N
        }
        catch(IntrospectionException e) {
            e.printStackTrace();
